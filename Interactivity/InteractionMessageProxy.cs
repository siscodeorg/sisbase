...
namespace sisbase.Interactivity
{
    ...
    {
        public class InteractionMessageProxySingle
        {
            public DiscordMessage Get() => null; // TODO
            ...
            public Task<DiscordMessage> RespondWithFileAsync(string fileName, Stream fileData, string content = null,
                bool tts = false, DiscordEmbed embed = null, IEnumerable<IMention> mentions = null) =>
                Get().RespondWithFileAsync(fileName, fileData, content, tts, embed);

            public Task<DiscordMessage> RespondWithFileAsync(FileStream fileData, string content = null,
                bool tts = false, DiscordEmbed embed = null, IEnumerable<IMention> mentions = null) =>
                Get().RespondWithFileAsync(fileData, content, tts, embed);

            public Task<DiscordMessage> RespondWithFileAsync(string filePath, string content = null,
                bool tts = false, DiscordEmbed embed = null, IEnumerable<IMention> mentions = null) =>
            ...
            public Task<DiscordMessage> RespondWithFilesAsync(Dictionary<string, Stream> files, string content = null,
                bool tts = false, DiscordEmbed embed = null, IEnumerable<IMention> mentions = null) =>
                Get().RespondWithFilesAsync(files, content, tts, embed);
